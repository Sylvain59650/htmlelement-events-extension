...
var specialEvents = ["longmousedown", "longkeydown", "nocontextmenu", "clickoutside"];
...
HTMLElement.prototype.on = function (evtName, fn, option) {
  ...
  var _loop = function _loop(i) {
    ...
    if (_this.addEventListener) {
      ...
      window.registerEvent(_this, evt, cb, option || false);
...
HTMLElement.prototype.off = function (evtNames, fn) {
  ...
  for (var i = 0; i < evts.length; i++) {
    ...
    if (this.removeEventListener) {
      window.unregisterEvent(this, _evt, fn);
