...
var specialEvents = ["longmousedown", "longkeydown", "nocontextmenu", "clickoutside", "multiclick", "onbeforeleave"];
...
function onBeforeLeave(fn, delay) {
  ...
  function checkMove() {
    var x = event.clientX;
    var y = event.clientY;
    if (initied && (x < 10 || y <= 10 || y > window.innerHeight - 10 || x > window.innerWidth - 10)) {
